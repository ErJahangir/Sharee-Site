      ...
      <Slider {...settings}>
        {blogdata.map((item, index) => (
          <div key={index} className="relative group shadow-md rounded-md">
            ...
            {/* Date badge */}
            <div className="absolute top-5 left-5 p-2 flex flex-col items-center gap-1 w-[70px] bg-[#fa8f47] rounded-full">
            ...
            <div className="p-2">
              ...
              <h2 className="text-[#868686] flex flex-row items-center justify-between mr-2">
                <span>
                  By:{" "}
                  <span className="text-black hover:text-[#fa8f47] capitalize duration-200">
                    {item.createdBy}
                  </span>
                </span>
              ...
              >
                <h2 className="text-[15px] md:text-[20px] hover:text-[#fa8f47] duration-200">
                  {item.title}
                </h2>
              </a>

              {/* Divider line */}
              <h2 className="w-[50px] md:w-[70px] border border-[#fa8f47] mt-2 mb-3"></h2>
